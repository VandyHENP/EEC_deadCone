...
FJCONTRIB_OPTS=$(FJCONTRIB_INCLUDE) $(FJCONTRIB_LIB)
ifeq ($(ROOT_USE),true)
...
# ROOT with FastJet. 
main142 EEC_pp EEC_eic EEC_pp_noEdgeEffects E3C_pp_bjet JetDist E2C_pp_EdgeEffects_Bjet E2C_pp_EdgeEffects E2C_eic E3C_pp_noEdgeEffects: $(PYTHIA) $$@.cc 
ifeq ($(ROOT_USE)$(FASTJET3_USE)$(FJCONTRIB_USE),truetruetrue)
	$(CXX) $@.cc -o $@ -w $(CXX_COMMON) $(FASTJET3_OPTS) -lfastjettools -lRecursiveTools -lConstituentSubtractor $(FJCONTRIB_OPTS) $(ROOT_OPTS)
else	
